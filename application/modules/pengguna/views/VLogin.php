...
<html lang="en">
  ...
  <body>
	...
	?>
    <div class="container">
      <form action="<?php echo base_url('auth/CAuth/login') ?>" class="form-signin" method="post">
        <center><h2 class="form-signin-heading">Silahkan Login</h2></center>
        <label for="inputEmail" class="sr-only">Username</label>
        <input type="text" id="inputEmail" name="name" class="form-control" placeholder="Username Please!" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" name="pass" class="form-control" placeholder="Password Here!" required>
        <div class="checkbox">
          <label>
