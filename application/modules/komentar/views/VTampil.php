            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                	...
                	<td><a href="<?php echo base_url().'komentar/CKomentar/Edit/'.$row->feed_id; ?>"><?php echo $row->feed_type; ?></a></td>
                	
                 
                  <td><a href="<?php echo base_url().'komentar/CKomentar/Hapus/'.$row->feed_id; ?>">hapus</a></td>
            	</tr>
            	<?php $i++;
            	endforeach; ?>
              </tbody>
