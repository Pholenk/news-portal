<div class="content-wrapper" style="min-height:654px;">
    ...
    <div class="col-xs-12">
        ...
        <form name="berkas" action="<?php echo base_url('posting/CPosting/Tambah/'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="col-md-6 col-xs-12">
                <div class="form-group col-xs-12 pull-right">
                    ...
                    <div class="col-xs-10">
                        <input type="text" id="inputUname" name="judul" class="form-control" placeholder="Judul..." required autofocus>
                    </div>
                </div>
                <div class="form-group col-xs-12 pull-right">
                    <div class="col-xs-2">
                ...
                <div class="form-group col-xs-12 pull-right">
                    ...
                    <div class="col-xs-10">
                        <textarea id="editor1" name="konten" class="form-control pull-left" placeholder="Konten..." required autofocus></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
