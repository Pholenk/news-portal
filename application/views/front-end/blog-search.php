                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xs-12 main-news">
                                                ...
                                                <center><h3 class="padding-bottom-60">Hasil Pencarian:</h2></center>
                                                <?php foreach ($result as $rows){ ?>
                                                    <div class="single-recent-post-widget">
                                                        <a href="#" class="thumb"><img src="<?php echo base_url().'gambar/'.$rows->post_name.'_thumb.jpg'?>" alt="<?php echo $rows->post_name?>.jpg" class="img-wrapper"></a>
                                                        <div class="post-info"><a href="<?php echo base_url('posting/CPosting/baca/'.$rows->post_name)?>" class="title"><?php echo $rows->post_title; ?></a>
                                                            <ul class="info">
